...
class App extends Component {
  constructor() {
    ...
    this.returnChangeHandler = this.returnChangeHandler.bind(this)
  }
  ...
  componentDidMount() {
    ...
    fetch(userAPI + "/" + loggedInUserId, {
      ...
      .then((data) => {
        if (data) {
          this.setState((prevState)=>({...prevState,loggedInUser: data }));
        }
      })
      .catch((err) => {
        console.error(err);
  ...
  returnChangeHandler(keyword){
    this.setState(prevState =>({...prevState, searchKeyword: keyword}), ()=>{
